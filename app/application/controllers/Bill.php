...
class Bill extends MY_Controller
{
	...
	public function edit($bill_no)
	{
		...
		if($this->input->post('submit'))
		{
			...
			*/
			...
			redirect('bill/view/' . $bill['bill_no']);
		}
	...
	public function create()
	{
		...
		if($this->input->post('submit'))
		{
			...
			$this->data['subview'] = 'bill/bill_pdf';
			$this->load->view('bill/bill_pdf', $this->data);
			...
			*/
			...
			$html = $this->load->view('bill/bill_pdf', $this->data, true);
	...
	public function receipt($bill_no)
	{
		...
		$this->data['subview'] = 'bill/receipt';
		$this->load->view('_main', $this->data);
	}
	...
	public function customer()
	{
		...
		$this->data['subview'] = 'bill/customer';
		//echo "<pre>";
