                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group text-center">
                                    <a class="btn btn-primary" href="<?php echo base_url('notax/receipt/'.$bill_row->bill_no); ?>">Add Receipt</a>
                                    <a class="btn btn-primary" href="<?php echo base_url('notax/edit/'.$bill_row->bill_no); ?>">Edit</a>
                                    <a class="btn btn-primary" href="<?php echo base_url('notax/bill_pdf/'.$bill_row->bill_no); ?>">Download PDF</a>
